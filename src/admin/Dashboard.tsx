...
import { formatTodayDate, statusDetailLabel } from "@/lib/requisitionStatus";
    ...
    <main className="flex min-h-screen flex-col overflow-x-hidden bg-background text-foreground">
      ...
      <div className="flex min-w-0 flex-1 flex-col pt-14 md:pl-72 md:pt-0">
        ...
        <div className="container mx-auto flex flex-1 flex-col py-8">
          ...
          <div className="mt-6 grid flex-1 gap-4 lg:grid-cols-3 lg:items-stretch">
            <div className="h-full lg:col-span-2">
              <AdminNeedActionCard className="h-full" />
            </div>
                      ...
                      <TableBody>
                        {recentSubmissions.map((row) => (
                          <TableRow key={row.requisitionId}>
                            ...
                            <TableCell className="text-muted-foreground">{row.staffName}</TableCell>
