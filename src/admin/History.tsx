...
type AdminHistoryStatus = "submitted" | "pending" | "approved" | "rejected";
...
function StatusBadge({ status }: { status: AdminHistoryStatus }) {
  const variant =
...
export function AdminHistoryPage() {
  const [statusFilter, setStatusFilter] = React.useState<AdminHistoryStatus | "all">("all");
        ...
        <div className="container mx-auto py-8">
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>Filter requisitions by status.</CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4">
              <Tabs value={statusFilter} onValueChange={(v) => setStatusFilter(v as AdminHistoryStatus | "all")}>
