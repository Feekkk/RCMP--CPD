        ...
        <div className="grid gap-12 md:grid-cols-3">
          <div>
            <div className="flex items-center gap-3">
                <img src="/rcmp-white.png" alt="UniKL RCMP logo" width={100} height={100} className="h-20 w-20 object-contain" />
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-background/75">
              Universiti Kuala Lumpur RCMP. Supporting professional
          ...
          <div>
            ...
            <p className="mt-5 text-sm text-background/80">
              Human Capital Office, UniKL RCMP<br />
